...
void ArraySort(int *);
void ArrayCompare(int *);
void FrequencyCount(int *);
    ...
    do
    {
        ...
        while (GameState <= 0 || GameState > 6)
        {
            ...
            while(GameState == 1)
            {
                ...
                ArrayInput(ArrayLotto, Freqency);
                GameState = 0;
                GamePlay = 1;
                NumSort = 0;
            }
...
//functions
void ArrayInput(int *LottoIn, int *FrequencyCount)//the input array
{
...
void ArrayCompare(int *LottoIn)//compare user input to winning numbers
{
    int i = 0;
    int j = 0;
    int temp = 0;
...
void FrequencyCount(int *FrequencyCount)//displays number selection frequency
{
